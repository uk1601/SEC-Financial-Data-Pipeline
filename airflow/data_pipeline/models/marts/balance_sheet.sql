-- -----------------------------------------------------------------------------
-- File: airflow/data_pipeline/models/marts/balance_sheet.sql
-- -----------------------------------------------------------------------------
-- Mart model: Aggregated Balance Sheet
-- Joins staging tables to produce total reported amounts for Balance Sheet items
-- -----------------------------------------------------------------------------
...
WHERE
    p.statement_type = 'BS'              -- Filter only Balance Sheet items
GROUP BY
    s.company_name,
    s.company_id,
    s.filing_date,
