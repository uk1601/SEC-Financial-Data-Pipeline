-- -----------------------------------------------------------------------------
-- File: airflow/data_pipeline/models/marts/income_statement.sql
-- -----------------------------------------------------------------------------
-- Mart model: Aggregated Income Statement
-- Joins staging tables to produce total reported amounts for Income Statement items
-- -----------------------------------------------------------------------------
...
WHERE
    p.statement_type = 'IS'              -- Filter only Income Statement items
GROUP BY
    s.company_name,
    s.company_id,
    s.filing_date,
